...
2. Launch FrostmourneGui.exe on an authorized Windows x86-capable machine with .NET Framework 4.x. Choose the EXACT target Wow.exe, keep the bundled FrostmourneBootstrap.dll checked, and press URUCHOM WOW once. The loader does not retry failed loads.
